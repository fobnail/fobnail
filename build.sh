...
if [ -n "${FOBNAIL_PO_ROOT}" ]; then
    FOBNAIL_SDK_DOCKER_EXTRA_OPTS+=" -e FOBNAIL_PO_ROOT=${FOBNAIL_PO_ROOT}"
fi

if [ -n "${FOBNAIL_EK_ROOT_DIR}" ]; then
    FOBNAIL_SDK_DOCKER_EXTRA_OPTS+=" -e FOBNAIL_EK_ROOT_DIR=${FOBNAIL_EK_ROOT_DIR}"
fi

if [ -n "${FOBNAIL_EXTRA_EK_ROOT}" ]; then
    FOBNAIL_SDK_DOCKER_EXTRA_OPTS+=" -e FOBNAIL_EXTRA_EK_ROOT=${FOBNAIL_EXTRA_EK_ROOT}"
fi
